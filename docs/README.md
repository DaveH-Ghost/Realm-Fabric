...
**Current release:** **1.6.1** — structure hardening, lint/CI, Mermaid UML. See [changelog index](changelog/README.md). Library-first since 1.0; [Migration 0.7 → 1.0](MIGRATION-0.7-to-1.0.md) still applies for older upgrades.
