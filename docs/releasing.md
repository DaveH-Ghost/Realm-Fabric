...
uv pip install dist\campaign_rpg_engine-1.0.0-py3-none-any.whl
...
```powershell
uv pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ campaign-rpg-engine==1.0.0
```
