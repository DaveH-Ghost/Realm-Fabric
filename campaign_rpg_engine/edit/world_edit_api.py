...
def find_object_in_session(session: Session, object_id: str) -> tuple[str, Area, Object] | None:
...
def create_object_from_fields(area: Area, fields: dict[str, str]) -> tuple[Object | None, str]:
    """Bridge from CLI field dict to typed create (used by ``create_object_from_args``)."""
    from campaign_rpg_engine.edit.area_edit import parse_object_action_fields, parse_position
...
def create_agent_from_fields(area: Area, fields: dict[str, str]) -> tuple[Agent | None, str]:
    """Bridge from CLI field dict to typed create (used by ``create_agent_from_args``)."""
    from campaign_rpg_engine.edit.area_edit import parse_position
