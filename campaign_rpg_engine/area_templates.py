...
from campaign_rpg_engine.decoration_edit import add_decoration_to_area
...
from campaign_rpg_engine.world_edit_api import delete_object_in_session
...
def _spawn_decorations_from_template(
    ...
    backgrounds = [
        d for d in template.get("decorations", [])
